import type { UserProfile } from '../user/user.type.js';
import type { SIGNIN_METHODS, SIGNIN_METHODS_ENABLED } from './auth.constant.js';

/** Người dùng chọn đăng nhập bằng gì. */
